...
echo '<meta name="author" content="' . K_TCEXAM_AUTHOR . '"/>'.K_NEWLINE;
...
echo '<script type="text/javascript" src="/opts/mathjax/MathJax.js?config=TeX-AMS-MML_SVG.js&locale=zh-hans" ></script>';
