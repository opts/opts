 ...
 * TCExam title.
 */
define ('K_TCEXAM_TITLE', 'whatis opts');

/**
 * TCExam description.
 */
define ('K_TCEXAM_DESCRIPTION', 'A free flexible cbt system');

/**
 * TCExam Author.
 */
define ('K_TCEXAM_AUTHOR', 'authors');

/**
 * Reply-to meta tag.
 */
define ('K_TCEXAM_REPLY_TO', 'webmaster@saltyremix.com');

/**
 * Default html meta keywords.
 */
define ('K_TCEXAM_KEYWORDS', 'web, exam, physics');
