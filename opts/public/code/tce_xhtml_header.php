...
echo '<meta name="description" content="' . K_SITE_DESCRIPTION . '" />'.K_NEWLINE;
echo '<meta name="author" content="' . K_SITE_AUTHOR . '"/>'.K_NEWLINE;
...
echo '<script type="text/javascript" src="/opts/mathjax/MathJax.js?config=MML_HTMLorMML-full.js&locale=zh-hans" ></script>';
