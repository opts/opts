 ...
 * Default site name.
 */
define ('K_SITE_TITLE', 'OPTS');

/**
 * Default site description.
 */
define ('K_SITE_DESCRIPTION', 'Online Physics Testing System');

/**
 * Default site author.
 */
define ('K_SITE_AUTHOR', 'dye E. jarhoo');
 ...
 * Default keywords.
 */
define ('K_SITE_KEYWORDS', 'OPTS, eExam, e-exam, CAS, exam');
